...
# os.system("b2 sync b2://akash-thumper-v1-training-images/ /home/ray/train_data  --skipNewer --threads 32 ")
os.system("b2 sync /home/ray/train_data b2://akash-thumper-v1-training-images/ --skipNewer --threads 32 ")