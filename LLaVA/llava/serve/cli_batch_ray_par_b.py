...
class Actor:
    ...
    def inference(self):
        ...
        # boto3.setup_default_session( region_name='auto', aws_access_key_id='************', aws_secret_access_key='bf04725158238e07724b8b015fbc4b6920e8679415b3073597f902563c024680')
        # https://1bc41b2b0e650ce51e4c6620c4632ac1.r2.cloudflarestorage.com/akash-thumper-v1-training-images
        # - R2_ACCESS_KEY_ID=************
