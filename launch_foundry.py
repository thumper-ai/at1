...
class JobScheduler:
    ...
    def schedule_job(self, config, args):
        ...
        if args.env !="pixart":
            runtime_env= { "working_dir": log_dir, "config":{"setup_timeout_seconds":35600},
                    #  "pip": ["git+https://github.com/rakataprime/at1.git@main#egg=llava&subdirectory=LLaVA", "setuptools", "git+https://github.com/fsspec/s3fs"
                            ...
                            #    "shortuuid"
                                #    ]
                    "conda": {"dependencies": [ "git-lfs", "pip", {"pip": [
                    "git+https://github_pat_ENTER_GITHUB_KEY@github.com/rakataprime/at1.git@main#egg=llava&subdirectory=LLaVA",
                    # "setuptools", 
                    "git+https://github.com/fsspec/s3fs", "bitsandbytes", "seaborn", "matplotlib",
                    "pandas",  "fastparquet", "numpy" , "gputil",
                    'b2',
                    # 'git+https://github.com/fsspec/s3fs', 
                    'fsspec', #'s3fs',
             ...
             runtime_env= { "env_vars": {"OPENBLAS_NUM_THREADS":"1"} , "config":{"setup_timeout_seconds":35600}, "working_dir": log_dir,
                # "conda": {"channels":["conda-forge"], "dependencies": [ "s5cmd", "s3fs", 'pandas', 'fastparquet', 'git-lfs',  # "pytorch" "torchvision" "torchaudio","pytorch-cuda=11.8",
                # "pip" , {"pip": [
                # # "git+https://github.com/rakataprime/at1.git@main#egg=pixart-alpha&subdirectory=PixArt-alpha" , 
                # # "setup/tools", #"git+https://github.com/fsspec/s3fs",
                # "b2",
                # "numpy" ,
                # # 'fsspec', #'s3fs',
                # # "git+https://github.com/rom1504/img2dataset",
                ...
                # ]}]}}
                #  "pip": [ "pandas", "huggingface_hub", "fastparquet", "b2", "bs4", "fastapi", "uvicorn", "torch==2.0.1", "boto3", "s3fs" , "shortuuid" , "tensorboard", "transformers==4.26.1", "sentencepiece", "ftfy>=6.1.1", "beautifulsoup4", "opencv-python","einops", "cloudpathlib[s3]","xformers",
                #         "more-itertools", "timm==0.6.12", "diffusers", "accelerate", "mmcv==1.7.0", "optimum", "yapf==0.40.1", "numpy", "pandas", "opencv-python", "cloudpickle==2.2.0","py-spy"]}

                "pip": [ "wandb", "eventlet", "protobuf==3.20.0", "aiobotocore",  "tensorboardX", "pandas",'img2dataset', 'webdataset', 'numba', 'gputil', "mosaicml-streaming", "huggingface_hub", "fastparquet", "b2", "bs4", "fastapi", "uvicorn", "boto3", "s3fs" , "shortuuid" , "tensorboard", "sentencepiece", "ftfy>=6.1.1", "beautifulsoup4", "opencv-python","einops", "cloudpathlib[s3]","xformers",
                        "more-itertools", "timm==0.6.12", "diffusers", "accelerate==0.25.0", "mmcv==1.7.0", "optimum", "yapf==0.40.1", "numpy", "pandas", "opencv-python", "cloudpickle==2.2.0", "py-spy", "transformers", "einops", "git+https://github.com/openai/CLIP.git", "torch==2.1.2",# "torch==2.0.1", # "torchview", #"transformers==4.26.1",
                        ]}

        
        # runtime_env= { "working_dir": log_dir,
        #             "conda": {"dependencies": [ "pip", "git-lfs", {"pip": [
        #                 # "git+https://github.com/rakataprime/at1.git@main#egg=llava&subdirectory=LLaVA" ,
        #             "git+https://github.com/thumper-ai/LLaVA.git@main#egg=llava",
        #             "more_itertools",
        ...
        #             "fastapi", 
        #             "boto3", 
        #             'bs4', 'git+https://github.com/fsspec/s3fs',  
        ...
        #             # "more-itertools"
        #             ]}]}
        #             # "pip": ["git+https://github.com/thumper-ai/LLaVA.git", "pandas", "fastparquet", "b2", "bs4", "fastapi", "torch==2.0.1", 'git+https://github.com/fsspec/s3fs' , "shortuuid"  ]

        #             }# "git+https://github.com/TimDettmers/bitsandbytes"                                        ]}]}, 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ray-address",  default='provider.akash.foundrystaking.com:30147', type=str)
    parser.add_argument("--dash-address" ,  default='http://provider.akash.foundrystaking.com:30377', type=str) #8265 default port
...
#  python3 launch.py --jobname download --cmd 'python download_models.py'
    ...
    # python3 launch.py --jobname createdataset --cmd 'python i2dataset.py -n_processes 4 --out_folder s3://akash-thumper-v1-training-images.s3.us-east-005.backblazeb2.com'
