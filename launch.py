...
class JobScheduler:
    ...
    def schedule_job(self, config, args):
        ...
        if args.env !="pixart":
            ...
            #         ]}]}
            #         }# "git+https://github.co
            runtime_env= { #s"working_dir": log_dir,
                    #  "pip": ["git+https://github.com/rakataprime/at1.git@main#egg=llava&subdirectory=LLaVA", "setuptools", "git+https://github.com/fsspec/s3fs"
            ...
            runtime_env= { "env_vars": {"OPENBLAS_NUM_THREADS":"1"} , "config":{"setup_timeout_seconds":3600}, "working_dir": log_dir,
                ...
                # ]}]}}
                "pip": [ "pandas", "mosaicml-streaming","fastparquet", "b2", "bs4", "fastapi", "uvicorn", "torch==2.0.1", "boto3", "s3fs" , "shortuuid" , "tensorboard", "transformers==4.26.1", "sentencepiece", "ftfy>=6.1.1", "beautifulsoup4", "opencv-python","einops", "cloudpathlib[s3]","xformers",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ray-address",  default='provider.akash-ai.com:32123', type=str)
    parser.add_argument("--dash-address" ,  default='http://provider.akash-ai.com:30486', type=str) #8265 default port
