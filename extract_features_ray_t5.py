        ...
        with torch.no_grad():
            for a in self.dirs:
                ...
                try:
                    ...
                    print(e)
                if a % 1000 == 0:
                    os.system("b2 sync /home/ray/train_data/t5/ b2://akash-thumper-v1-t5-data --skipNewer")
...
def get_args():
    ...
    parser.add_argument('--vae_dir', default="/home/ray/models/PixArt-alpha/output/pretrained_models/sd-vae-ft-ema", type=str)
    parser.add_argument('--t5_dir', default="/home/ray/models/PixArt-alpha/output/pretrained_models/t5-v1_1-xxl", type=str)
    parser.add_argument('--model_path_dir', default="/home/ray/models/PixArt-alpha/output/pretrained_models/t5-v1_1-xxl", type=str)
