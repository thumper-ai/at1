...
def build_dataloader(dataset, batch_size=256, num_workers=0, shuffle=True, ray= True, **kwargs):
    if 'batch_sampler' in kwargs:
        dataloader = DataLoader(dataset, batch_sampler=kwargs['batch_sampler'], num_workers=num_workers, pin_memory=False)
