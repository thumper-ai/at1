...
if __name__ == '__main__':
    ...
    def train_func(config):
        ...
        s3 = s3fs.S3FileSystem(#anon=True, 
            ...
            #                        secret='*****************',
                                endpoint_url='ENTER_URL_HERE', version_aware=True)
        s3.get('akash-thumper-v1-checkpoints/TorchTrainer_2023-12-19_01-10-48/TorchTrainer_802ac_00000_0_2023-12-19_01-10-49/checkpoint_000049/epoch_160_step_0.pth',
    ...
    #   num_canonical_nodes: 64
        ...
        for epoch in range(start_epoch + 1, config.num_epochs + 1):
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                logs = {"loss": loss.item()}
                metrics = {"loss": loss.detach().item(), "step": global_step +step, "epoch":epoch }
                ...
                if ray.train.get_context().get_world_rank() == 0 and step ==0 and epoch % 2 == 0 and epoch >1:
...
#akash-thumper-v1-checkpoints/TorchTrainer_2023-12-19_01-10-48/TorchTrainer_802ac_00000_0_2023-12-19_01-10-49/checkpoint_000047epoch_156_step_0.pth