...
if __name__ == '__main__':
    ...
    def train_func(config):
        ...
        s3 = s3fs.S3FileSystem(#anon=True, 
            ...
            #                        secret='*****************',
                                endpoint_url='ENTER_URL_HERE', version_aware=True)
        s3.get('akash-thumper-v1-checkpoints/TorchTrainer_2023-12-14_16-57-54/TorchTrainer_fb51c_00000_0_2023-12-14_16-57-55/checkpoint_000001/epoch_40_step_1000.pth',
