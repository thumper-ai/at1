...
if __name__ == '__main__':
    ...
    def train_func(config):
        ...
        s3 = s3fs.S3FileSystem(#anon=True, 
            ...
            #                        secret='*****************',
                                endpoint_url='ENTER_URL_HERE', version_aware=True)
        if not os.path.exists("/home/ray/ray_results/epoch_14_step_1236.pth"):
            ...
            s3.get('akash-thumper-v1-checkpoints/TorchTrainer_2023-12-27_15-34-10/TorchTrainer_70101_00000_0_2023-12-27_15-34-11/checkpoint_000003/epoch_14_step_1236.pth',
...
# epoch_58_step_0
    ...
    trainer = TorchTrainer(
        ...
        scaling_config=ScalingConfig(num_workers=args.n_gpu_workers, use_gpu=True, resources_per_worker={"GPU": 1, "CPU":8 }
                                     )
    )
