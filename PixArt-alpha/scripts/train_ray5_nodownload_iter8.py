...
if __name__ == '__main__':
    ...
    def train_func(config):
        ...
        s3 = s3fs.S3FileSystem(#anon=True, 
            ...
            #                        secret='*****************',
                                endpoint_url='ENTER_URL_HERE', version_aware=True)
        s3.get('akash-thumper-v1-checkpoints/TorchTrainer_2023-12-13_17-15-17/TorchTrainer_3f046_00000_0_2023-12-13_17-15-19/checkpoint_000001/epoch_24_step_600.pth',
