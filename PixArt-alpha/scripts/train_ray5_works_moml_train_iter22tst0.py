...
if __name__ == '__main__':
    ...
    def train_iter(batch, train_diffusion, lr_scheduler, model, optimizer, global_step, step, epoch):
        with torch.no_grad():
    ...
    #   num_canonical_nodes: 64
        ...
        for epoch in range(start_epoch + 1, config.num_epochs + 1):
            ...
            for step, batch in enumerate(train_dataloader):
                metrics = train_iter(batch, train_diffusion, lr_scheduler, model, optimizer, global_step, step, epoch)
