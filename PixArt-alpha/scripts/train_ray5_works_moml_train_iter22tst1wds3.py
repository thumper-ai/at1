...
if __name__ == '__main__':
    ...
    def train_func(config):
        ...
        train_dataloader = train_data_shard.iter_torch_batches(
                            ...
                            batch_size=32, #32, #dtypes={"vae": torch.float32, "txt_features": torch.float32, "attention_mask": torch.int32}
                        )
    ...
    #   num_canonical_nodes: 64
        ...
        # model, model_ema, optimizer, train_dataloader, lr_scheduler = accelerator.prepare(model, model_ema, optimizer, train_dataloader, lr_scheduler)
