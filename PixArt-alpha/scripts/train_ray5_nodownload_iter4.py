...
if __name__ == '__main__':
    ...
    def train_func(config):
        ...
        s3 = s3fs.S3FileSystem(#anon=True, 
            ...
            #                        secret='*****************',
                                endpoint_url='ENTER_URL_HERE', version_aware=True)
        s3.get('Akash-thumper-v1-checkpoints/TorchTrainer_2023-12-13_09-50-56/TorchTrainer_2ba01_00000_0_2023-12-13_09-50-57/checkpoint_000001',
    ...
    s3 = s3fs.S3FileSystem(#anon=True, 
            ...
            #                        secret='*****************',
                                endpoint_url='ENTER_URL_HERE', version_aware=True)
    s3.get('akash-thumper-v1-checkpoints/TorchTrainer_2023-12-13_02-12-35/TorchTrainer_24002_00000_0_2023-12-13_02-12-37/checkpoint_000001/epoch_8_step_1072.pth',
        "/home/ray/ray_results/")
