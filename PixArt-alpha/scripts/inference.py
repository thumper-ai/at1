...
if __name__ == '__main__':
    ...
    vae = AutoencoderKL.from_pretrained(args.tokenizer_path , local_cache=True, torch_dtype=torch.float16 ).to(device)
    t5 = T5Embedder(dir_or_name=args.t5_path , device="cuda", local_cache=True, cache_dir=args.t5_path, torch_dtype=torch.float16)
    ...
    # python3 scripts/inference.py --image_size=1024 --t5_path /home/logan/thumperai/weights/PixArt-alpha/t5-v1_1-xxl --tokenizer_path /home/logan/thumperai/weights/PixArt-alpha/sd-vae-ft-ema --model_path /home/logan/ray_results/checkpoint_000029/epoch_120_step_0.pth --step 30 --save_name test_sample_0