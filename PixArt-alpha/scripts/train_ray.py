...
if __name__ == '__main__':
    ...
    def download_dataset(head=False):
        ...
        captions= [captions[i] for i in range(40)]
    ...
    def train_func(config):
        ...
        if config.multi_scale:
            batch_sampler = AspectRatioBatchSampler(sampler=RandomSampler(dataset), dataset=dataset,
                                                    batch_size=args.bs, #config.train_batch_size
            ...
            train_dataloader = build_dataloader(dataset, num_workers=0, batch_size=args.bs, #config.train_batch_size,
                                                 shuffle=True)
