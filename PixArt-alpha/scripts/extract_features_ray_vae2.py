        ...
        with torch.no_grad():
            for a in range(len(self.captions)):
                ...
                try:
                    ...
                    np.save(save_path, z)
                    print(save_path)
                    s3.put(save_path, "akash-thumper-v1-vae-data")
                ...
                # if a % 5 == 0:
                #     os.system("b2 sync /home/ray/train_data/img_vae_feature/ b2://akash-thumper-v1-vae-data")
                    
        os.system("b2 sync /home/ray/train_data/img_vae_feature/ b2://akash-thumper-v1-vae-data --skipNewer")
        return
