...
def main(args):
	...
	import pandas as pd
	# df = pd.read_parquet(f"s3://akash-thumper-v1-files/df_download_images.parquet", 
	# 				storage_options={"key":'****************',
	# 								"secret":'****************',
	...
	# df= df.loc[(df["HEIGHT"] > 420) & (df["WIDTH"] > 420 ) ,:]
	df.to_parquet("/home/ray/train_data/subset.parquet")
	...
	img2dataset.download(
		...
		retries=0,
		timeout=10,
		url_list='/home/ray/train_data/subset.parquet',
...
if __name__ == "__main__":
	...
	parser.add_argument("--url_list",  default='/home/ray/train_data/cc_face_300k.parquet', type=str)
	parser.add_argument("--out_folder", default='s3://akash-thumper-v1-face-256', type=str)
